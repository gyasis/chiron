 ...
 *  - Lesson dir: ~/Documents/generated/chiron-acute-pericarditis-amboss/
...
const OUT_DIR = resolve(process.env.HOME, 'Documents', 'generated', 'chiron-acute-pericarditis-amboss');
...
// ── lesson metadata ───────────────────────────────────────────────────────────
const lessonTitle = brief.metadata?.topic ?? brief.topic ?? 'Acute Pericarditis';
const lessonDate = new Date().toISOString().slice(0, 10);
const lessonId = 'chiron-acute-pericarditis-amboss';
...
${chaptersHtml}
    ...
    <section class="sr-deck-section" id="sr-deck">
      ...
      <p class="sr-deck-help">Click any card to flip. Front = concept. Back = key fact + source tags. All ${allSrIdioms.length} cards from all 7 chapters.</p>
