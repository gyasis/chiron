 ...
 *  - Lesson dir: ~/Documents/generated/chiron-klinefelter-amboss/
...
const OUT_DIR = resolve(process.env.HOME, 'Documents', 'generated', 'chiron-klinefelter-amboss');
...
// ── lesson metadata ───────────────────────────────────────────────────────────
const lessonTitle = brief.metadata?.topic ?? brief.topic ?? 'Klinefelter Syndrome (47,XXY)';
const lessonDate = new Date().toISOString().slice(0, 10);
const lessonId = 'chiron-klinefelter-amboss';
